...
public class ExtendedIdentityProvider extends IdentityProvider {
    ...
    public String getUniqueId() {
        ...
        String idpUniqueId = null;

        if (StringUtils.isNotEmpty(identityProvider.getId())) {
            idpUniqueId = Constants.IDP_UNIQUE_ID_PREFIX + identityProvider.getId();
        } else {
            idpUniqueId = Constants.IDP_UNIQUE_ID_PREFIX + identityProvider.getIdentityProviderName();
        }
        return IdentityUtil.base58Encode(idpUniqueId.getBytes());
    }
